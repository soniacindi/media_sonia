		...
		<div class="col-lg-8 col-md-8">
			<div class="kotak">
				<div class="isi"> 
					...
					<img src="/media_sonia-main/image/30.png" width="60%" alt="">
					<div class="subjudul">
					...
					<img src="/media_sonia-main/image/31.png" width="60%" alt="">
					<div class="subjudul">
					...
					<img src="/media_sonia-main/image/32.png" width="60%" alt="">
					<div class="subjudul">
					...
					<img src="/media_sonia-main/image/33.png" width="60%" alt="">
				</div>
				<div class="subjudul">
					...
					<img src="/media_sonia-main/image/34.png" width="60%" alt="">
					<div class="row halaman">
		  		<div class="judul-halaman">Materi Lainnya</div>
		  		<div class="col-6">
		  			<a class="halaman-kiri" href="#" aria-label="Previous"  onclick="location='/media_sonia-main/konten/bab4_strukturKonseptualBasisData.php'">
						  <span aria-hidden="true">&larr;</span>
						  Sebelumnya
					  </a>
		  		</div>
				  <div class="col-6 geser-kanan">
						<a class="halaman-kanan" href="#" aria-label="Next"  onclick="location='/media_sonia-main/konten/bab6_pengantarNormalisasiData.php'">
						  Selanjutnya
