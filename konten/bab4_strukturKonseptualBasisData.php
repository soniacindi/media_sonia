				...
				<div class="isi"> 
					...
					<ol >
						...
						<li>
							...
							<img src="/media_ajar/image/10.png" width="70%" alt="">
							<div>
					...
					<div>
						...
						<ol>
							<li>
								...
								<img src="/media_ajar/image/11.png" width="70%" alt="">
							</li>
							<li>
								...
								<img src="/media_ajar/image/12.png" width="70%" alt="">
							</li>
							<li>
								...
								<img src="/media_ajar/image/13.png" width="70%" alt="">
							</li>
							<li>
								...
								<img src="/media_ajar/image/14.png" width="70%" alt="">
							</li>
							<li>
								...
								<div>
									<img src="/media_ajar/image/15.png" width="70%" alt="">
								</div>
							</li>
							<li>
								...
								<ol type="a">
									...
									<img src="/media_ajar/image/16.png" width="70%" alt="">
									<li>
									...
									<img src="/media_ajar/image/17.png" width="70%" alt="">
								...
								<ol>
									...
									<img src="/media_ajar/image/18.png" width="70%" alt="">
									<li>
										Relasi binary adalah sebuah relasi dengan dua entitas.
									</li>
									<img src="/media_ajar/image/19.png" width="70%" alt="">
									<li>
										Relasi unary merupakan relasi dengan jumlah entitas hanya satu saja, relasi unary ini terjadi karena sebuah himpunan entitas ke himpunan entitas yang sama seperti entitas tadi.
									</li>
									<img src="/media_ajar/image/20.png" width="70%" alt="">
									<li>
									...
									<ol type="a">
										...
										<img src="/media_ajar/image/21.png" width="70%" alt="">
										<img src="/media_ajar/image/22.png" width="70%" alt="">
										<li>
										...
										<img src="/media_ajar/image/23.png" width="70%" alt="">
										<img src="/media_ajar/image/24.png" width="70%" alt="">
										<img src="/media_ajar/image/25.png" width="70%" alt="">
										<li>
										...
										<img src="/media_ajar/image/26.png" width="70%" alt="">
										<img src="/media_ajar/image/27.png" width="70%" alt="">
									</ol>
								</ol>
								...
								<ol>
									...
									<img src="/media_ajar/image/28.png" width="70%" alt="">
									<li>
									...
									<img src="/media_ajar/image/29.png" width="70%" alt="">
								</ol>
							</li>
						</ol>
					</div>
		  		...
		  		<div class="col-6">
		  			<a class="halaman-kiri" href="#" aria-label="Previous"  onclick="location='/media_ajar/konten/bab3_modelHierarkiBasisData.php'">
						  <span aria-hidden="true">&larr;</span>
						  Sebelumnya
					  </a>
		  		</div>
				  <div class="col-6 geser-kanan">
						<a class="halaman-kanan" href="#" aria-label="Next"  onclick="location='/media_ajar/konten/bab5_mappingER.php'">
						  Selanjutnya
