		...
		<div class="col-lg-8 col-md-8">
			<div class="kotak">
				<div class="isi"> 
					...
					<div>
						<ol>
							<li>
								...
								<div><img src="/media_ajar/image/67.png" width="70%" alt=""></div>
							</li>
							<li>
								...
								<div><img src="/media_ajar/image/68.png" width="70%" alt=""></div>
							</li>
							<li>
								...
								<div><img src="/media_ajar/image/69.png" width="70%" alt=""></div>
							</li>
							<li>
								Tampilan power designer setelah di atur untuk membuat CDM (Conceptual Data Model) baru.
								<div><img src="/media_ajar/image/70.png" width="70%" alt=""></div>
							</li>
							<li>
							...
							<li>
								...
								<div><img src="/media_ajar/image/76.png" width="70%" alt=""></div>
							</li>
							<li>
								...
								<div><img src="/media_ajar/image/77.png" width="70%" alt=""></div>
							</li>
							<li>
		  		...
		  		<div class="col-6">
		  			<a class="halaman-kiri" href="#" aria-label="Previous"  onclick="location='/media_ajar/konten/bab9_CDM.php'">
