		...
		<div class="col-lg-8 col-md-8">
			<div class="kotak">
				<div class="isi"> 
					...
					<img src="/media_sonia-main/image/4.png" width="60%" alt="">
					<div>
						...
						<li>
							...
							<ol type="a">
								<li>
									...
									<img src="/media_sonia-main/image/5.png" width="60%" alt="">
								...
								<li>
									...
									<img src="/media_sonia-main/image/6.png" width="60%" alt="">
								</li>
								<li>
									...
									<img src="/media_sonia-main/image/7.png" width="60%" alt="">
								</li>
							</ol>
							<li>
								...
								<ol type="a">
									<li>
										...
										<img src="/media_sonia-main/image/8.png" width="60%" alt="">
									</li>
									<li>
									...
									<li>
										...
										<img src="/media_sonia-main/image/9.png" width="60%" alt="">
									</li>
								</ol>
							</li>
						</li>
		  		...
		  		<div class="col-6">
		  			<a class="halaman-kiri" href="#" aria-label="Previous"  onclick="location='/media_sonia-main/konten/bab2_strukturHierarkiBasisData.php'">
						  <span aria-hidden="true">&larr;</span>
						  Sebelumnya
					  </a>
		  		</div>
				  <div class="col-6 geser-kanan">
						<a class="halaman-kanan" href="#" aria-label="Next"  onclick="location='/media_sonia-main/konten/bab4_strukturKonseptualBasisData.php'">
						  Selanjutnya
