	...
	<div class="col-lg-3 col-md-4" >
			<div class="daftar">
				...
				<div class="isi-materi" onclick="location='/media_sonia-main/konten/bab1_konsepBasisData.php'">
					<div class="judul-materi">
						Konsep Basis Data
					</div>
				</div>
				<div class="isi-materi" onclick="location='/media_sonia-main/konten/bab2_strukturHierarkiBasisData.php'">
					<div class="judul-materi">
						Struktur Hierarki Basis Data
					</div>
				</div>
				<div class="isi-materi">
					<div class="judul-materi" onclick="location='/media_sonia-main/konten/bab3_modelHierarkiBasisData.php'">
						Model Hierarki Basis Data
					</div>
				</div>
				<div class="isi-materi">
					<div class="judul-materi" onclick="location='/media_sonia-main/konten/bab4_strukturKonseptualBasisData.php'">
						Struktur Konseptual Basis Data
					</div>
				</div>
				<div class="isi-materi">
					<div class="judul-materi" onclick="location='/media_sonia-main/konten/bab5_mappingER.php'">
						Mapping ER ke Relasi Tabel
					</div>
				</div>
				<div class="isi-materi">
					<div class="judul-materi" onclick="location='/media_sonia-main/konten/bab6_pengantarNormalisasiData.php'">
						Pengantar Normalisasi Data
					</div>
				</div>
				<div class="isi-materi">
					<div class="judul-materi" onclick="location='/media_sonia-main/konten/bab7_bentukNormal.php'">
						Bentuk Normal
					</div>
				</div>
				<div class="isi-materi">
					<div class="judul-materi" onclick="location='/media_sonia-main/konten/bab8_alatBantuPemodelanKonseptualData.php'">
						Alat Bantu Pemodelan Konseptual Data
					</div>
				</div>
				<div class="isi-materi">
					<div class="judul-materi" onclick="location='/media_sonia-main/konten/bab9_CDM.php'">
						CDM
					</div>
				</div>
				<div class="isi-materi">
					<div class="judul-materi" onclick="location='/media_sonia-main/konten/bab10_membuatDiagramCDM.php'">
						Membuat Diagram CDM
					</div>
				</div>
			</div>
