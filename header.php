      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu">
            ...
            <li><a class="dropdown-item" href="#">Learning HTML</a></li>
            <li><a class="dropdown-item" href="#">Learning Aritificial Intellegent</a></li>
            <li><a class="dropdown-item" href="#">Learning Information Retrieval</a></li>
          </ul>
        </li>
        <li class="nav-item">
